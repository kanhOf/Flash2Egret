...
namespace annie {
    ...
    import MouseEvent=egret.TouchEvent;
    class McFrame {
    ...
    export class MovieClip extends DisplayObjectContainer {
         ...
         * @type {annie.Sprite}
         */
        public floatView:DisplayObjectContainer=new DisplayObjectContainer();
        /**
         * mc的当前帧
                ...
                if (s._isNeedUpdateChildren) {
                        ...
                        if (s.currentFrame <= frameCount) {
                            ...
                            if (frame.keyIndex == (s.currentFrame - 1)) {
                                ...
                                if (frame.eventName != "" && s.hasEventListener("onCallFrame")) {
                                    let event:any = new Event("onCallFrame");
                    ...
                    if ((s.currentFrame == 1 && !s.isFront) || (s.currentFrame == s.totalFrames && s.isFront)) {
                        if (s.hasEventListener("onEndFrame")) {
                            let event:any = new Event("onEndFrame");
                            event.data = {
